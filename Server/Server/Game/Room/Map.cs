...
namespace Server.Game
{
	...
	public class Map
	{
        ...
        {
			if (cellPos.x < MinX || cellPos.y > MaxY)
				return null;
			if (cellPos.x > MaxX || cellPos.y < MinY)
				return null;
		...
		public bool ApplyLeave(GameObject gameObject)
		{
			...
			if (posInfo.PosX < MinX || posInfo.PosY > MaxY)
				return false;
			if (posInfo.PosX > MaxX || posInfo.PosY < MinY)
				return false;
			{
